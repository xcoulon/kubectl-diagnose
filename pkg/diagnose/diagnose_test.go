...
var _ = DescribeTable("container in CrashLoopBackOff status",
	...
	Entry("should detect from deployment", diagnose.Deployment, "test", "crash-loop-back-off"),
...
var _ = DescribeTable("container in ImagePullBackOff status",
	...
	Entry("should detect from deployment", diagnose.Deployment, "test", "image-pull-back-off"),
...
var _ = DescribeTable("container with unknown configmap mount",
	...
	Entry("should detect from deployment", diagnose.Deployment, "test", "unknown-configmap"),
...
var _ = DescribeTable("container with readiness probe error",
	...
	Entry("should detect from deployment", diagnose.Deployment, "test", "readiness-probe-error"),
...
var _ = DescribeTable("serviceaccount not found",
	...
	Entry("should detect from deployment", diagnose.Deployment, "test", "sa-notfound"),
